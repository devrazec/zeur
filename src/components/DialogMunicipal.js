...
const DialogMunicipal = () => {
  const { dialogMunicipal, setDialogMunicipal } = useContext(GlobalContext);
  ...
  const municipios = [
    ...
    },
    {
      name: 'Arujá',
      phone: '(11) 4652-7600',
      url: 'https://www.prefeituradearuja.sp.gov.br/',
    },
    {
      name: 'Barueri',
      phone: '(11) 4199-1000',
      url: 'https://www.barueri.sp.gov.br/',
    },
    {
      name: 'Biritiba Mirim',
      phone: '(11) 4657-9000',
      url: 'https://www.biritibamirim.sp.gov.br/',
    },
  ];
  ...
  return (
    <div className="card flex justify-content-center">
      <Dialog
        ...
        onHide={() => {
          if (!dialogMunicipal) return;
          setDialogMunicipal(false);
        }}
        style={{ width: '50vw' }}
